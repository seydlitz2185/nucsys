...
import jakarta.servlet.annotation.WebServlet;
@WebServlet(name = "MarketFetchPageServlet", value = "/MarketFetchPageServlet")
public class MarketFetchPageServlet extends HttpServlet{
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //try{
        try {
            List<Market> oneMarket = marketMapper.selectRange(8*(page-1),8);
            if (oneMarket != null) {
