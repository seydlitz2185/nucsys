...
@WebServlet(name = "ExpressUserCancelServlet", value = "/ExpressUserCancelServlet")
public class ExpressUserCancelServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //try{
        try {
            int res = expressMapper.deleteById(expressId);
            if (res ==1) {
                UserLogin success = new UserLogin("","取消成功","","");
