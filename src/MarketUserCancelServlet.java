...
@WebServlet(name = "MarketUserCancelServlet", value = "/MarketUserCancelServlet")
public class MarketUserCancelServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //try{
        try {
            int res = marketMapper.deleteById(marketId);
            if (res ==1) {
