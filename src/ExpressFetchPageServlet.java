 ...
 * @author stevenyu
 */
@WebServlet(name = "ExpressFetchPageServlet", value = "/ExpressFetchPageServlet")

public class ExpressFetchPageServlet extends HttpServlet{
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //try{
        try {
            List<Express> oneExpress = expressMapper.selectRange(8*(page-1),8);
            if (oneExpress != null) {
