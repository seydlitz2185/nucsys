 ...
 * @author stevenyu
 */
@WebServlet(name = "DiningUserCancelServlet", value = "/DiningUserCancelServlet")
public class DiningUserCancelServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //try{
        try {
            int res = diningMapper.deleteById(diningId);
            if (res ==1) {
