 ...
 * @author stevenyu
 */
@WebServlet(name = "DiningFetchPageServlet", value = "/DiningFetchPageServlet")

public class DiningFetchPageServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //try{
        try {
            List<Dining> oneDining = diningMapper.selectRange(8*(page-1),8);
            if (oneDining != null) {
