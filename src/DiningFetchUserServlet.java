...
@WebServlet(name = "DiningFetchUserServlet", value = "/DiningFetchUserServlet")
public class  DiningFetchUserServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            List<Dining> oneDining = diningMapper.selectByUserId(userId,8*(page-1),8);
            if (oneDining != null) {
